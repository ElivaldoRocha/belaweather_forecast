const bulletinsSabado = [
  {
    ...
    text: "A distribuição de precipitação mostra acumulados significativos no extremo norte do Brasil, especialmente em Boa Vista (8,8 mm). As demais regiões apresentam pouca ou nenhuma precipitação, indicando um dia relativamente seco na maior parte do país.<br>No nordeste, João Pessoa registra 1,0 mm provavelmente com origem em brisas marítimas.<br>Na região sul, Porto Alegre registra acumulados de 0 mm.",
  },
  {
    title: "<i class='bi bi-speedometer'></i> Pressão:",
    text: "A análise da pressão atmosférica revela várias áreas de baixa pressão sobre o continente, especialmente no extremo norte do país (801 hPa) no cone sul (781 hPa), baixas pessões estão associadas a instabilidades e condições de mau tempo.<br><br> A Alta Subtropical do Atlântico Sul (ASAS) está atuando e influênciando diretamente na costa brasileira, altas pessões estão associadas a estabilidades e condições de bom tempo.",
  },
  {
    title: "<i class='bi bi-cloud-sun'></i> Radiação de Onda Longa:",
    text: "A Radiação de Onda Longa (ROL) reflete a emissão de energia térmica da superfície terrestre para a atmosfera. As áreas com maior ROL estão associadas a temperaturas mais elevadas, indicando intensa perda de energia térmica durante o período noturno.<br><br>As áreas com maior emissão de ROL estão concentradas no norte e nordeste do Brasil.<br><br> Destaques para Boa Vista (424,1 W/m²), Manaus (419,8 W/m²) e Cuiabá (378,8 W/m²).",
  },
  {
    title: "<i class='bi bi-sun'></i> Radiação de Onda Curta:",
    text: "A radiação de onda curta (ROC) representa a energia solar que atinge a superfície terrestre. As áreas com maior ROC estão associadas a intensa insolação, contribuindo para temperaturas elevadas durante o dia.<br><br>As áreas com maior incidência de ROC estão concentradas no norte e nordeste do Brasil.<br><br> Destaques para Boa Vista (424,1 W/m²), Manaus (419,8 W/m²) e Cuiabá (378,8 W/m²).",
  },
  {
    title: "<i class='bi bi-thermometer-high'></i> Temperatura Máxima:",
    text: "Indicam calor intenso nas regiões Norte e Nordeste do Brasil, com temperaturas acima de 32°C em cidades como Manaus (34,8°C), Belém (32,9°C) e Teresina (33,5°C).<br><br> As regiões Sul e Sudeste estão apesentando máximas elevadas para o período de inverno, variando de 21°C a 30°C.",
  },
  {
  ...
  },
  {
    ...
    text: "Variam significativamente, com regiões do Sul apresentando valores mais baixos, apesar que as mínimas também estão elevadas, como Porto Alegre (14,6°C), Florianópolis (15,6°C) e Curitiba (16,6°C).<br><br> Enquanto o Norte e Nordeste registram mínimas mais altas, como Manaus (27,4°C) e Natal (22,6°C).",
  },
  {
    title:
      "<i class='bi bi-thermometer-sun'></i><i class='bi bi-thermometer-snow'></i> Amplitude Térmica:",
    text: "A amplitude térmica é elevada em diversas partes do Brasil, indicando dias quentes seguidos de noites relativamente frias. Nas capitais litorâneas, a amplitude térmica é menor por causa da alta umidade relativa.<br><br> Destacam-se Rio Branco (11,7°C), Brasília (11,8°C), São Paulo (13,9°C), Teresina (13,0°C) e Belo Horizonte (15,9°C).",
  },
  {
    title: "<i class='bi bi-droplet-half'></i> Umidade Relativa:",
    text: "Os níveis de umidade relativa são elevados no Norte e Nordeste próximo ao litoral, com valores acima de 70%, favorecendo condições de maior desconforto térmico nessas áreas.<br>Alerta-se para regiões que apresentam baixa umidade relativa:<br>Na região sul do Estado do Pará,com umidade igual ou abaixo dos 50%.<br>Na região conhecida como MATUPIBA (Maranhão, Tocantins, Piauí e Bahia) com umidade igual ou abaixo dos 50%.<br>No Centro-Oeste a umidade está igual ou abaixo dos 50%,<br>No Sudeste, grande parte está apresentando umidade igual ou abaixo dos 50%,<br>Na região Sul, o Paraná apresenta níveis igual ou abaixo dos 50% com Curitiba registrando 59,5%.",
  },
  {
  ...
  },
  {
    ...
    text: "<ul><li><strong>Frentes:</strong> Uma frente fria pode ser observada avançando pela costa do cone Sul-Americano no Pacífico com centro de baixa pressão em 781 hPa.</li><li><strong>Zona de Convergência Intertropical:</strong> A ZCIT está bem definida e atuando no hemisfério norte de forma significativa na Guiana, Suriname e Guiana Francesa, próxima da linha do Equador. Este sistema é responsável por promover condições de maior instabilidade e precipitação nas regiões próximas, especialmente no norte da Amazônia (no verão do hemisfério sul) e partes do Caribe, como indicado pela baixa pressão (1012 hPa).</li></ul>",
  },
];
